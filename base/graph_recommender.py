...
class GraphRecommender(Recommender):
    ...
    def evaluate(self, rec_list):
        ...
        try :
            file_name = self.config['model.name'] + '-' + self.config['model.inputs_type'] + '@' + current_time + '-top-' + str(self.max_N) + 'items' + '.txt'
        except:
            file_name = self.config['model.name'] + '@' + current_time + '-top-' + str(self.max_N) + 'items' + '.txt'
        FileIO.write_file(out_dir, file_name, self.recOutput)
        print('The result has been output to ', abspath(out_dir), '.')
        try:
            file_name = self.config['model.name'] + '-' + self.config['model.lambda'] + '@' + current_time + '-performance' + '.txt'
        except:
